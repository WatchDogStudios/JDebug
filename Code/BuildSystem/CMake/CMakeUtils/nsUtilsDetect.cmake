...
macro(ns_pull_compiler_and_architecture_vars)
	...
	# enable_language is not cached and must thus be run here instead of in ns_detect_compiler_and_architecture as the early out at the start would of the function would disable ASM support again. This quirk for some reason only happens on Windows compiling for Android.
	if(NS_CMAKE_COMPILER_MSVC AND NS_CMAKE_ARCHITECTURE_64BIT)
