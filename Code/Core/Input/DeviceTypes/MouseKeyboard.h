...
public:
  ...
  nsVec2 GetLocalMouseCoordinates() const { return m_vLocalMouseCoordinates; }

protected:
  virtual void UpdateInputSlotValues() override;

  nsTime m_DoubleClickTime = nsTime::MakeFromMilliseconds(500);
  static nsInputDevice* s_pMouseOver;
  nsVec2 m_vLocalMouseCoordinates = nsVec2(0.0f);

private:
  nsVec2 m_vMouseScale = nsVec2(1.0f);
