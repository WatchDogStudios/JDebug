...
// clang-format off
NS_BEGIN_DYNAMIC_REFLECTED_TYPE(nsInputDeviceMouseKeyboard_GLFW, 1, nsRTTINoAllocator)
...
nsInputDeviceMouseKeyboard_GLFW::nsInputDeviceMouseKeyboard_GLFW(GLFWwindow* windowHandle)
  : m_pWindow(windowHandle)
{
}

nsInputDeviceMouseKeyboard_GLFW::~nsInputDeviceMouseKeyboard_GLFW()
{
}

void nsInputDeviceMouseKeyboard_GLFW::SetShowMouseCursor(bool bShow)
{
  glfwSetInputMode(m_pWindow, GLFW_CURSOR, bShow ? GLFW_CURSOR_NORMAL : GLFW_CURSOR_DISABLED);
}

bool nsInputDeviceMouseKeyboard_GLFW::GetShowMouseCursor() const
{
  return (glfwGetInputMode(m_pWindow, GLFW_CURSOR) != GLFW_CURSOR_DISABLED);
}

void nsInputDeviceMouseKeyboard_GLFW::SetClipMouseCursor(nsMouseCursorClipMode::Enum mode)
{
}

nsMouseCursorClipMode::Enum nsInputDeviceMouseKeyboard_GLFW::GetClipMouseCursor() const
{
  return nsMouseCursorClipMode::Default;
}

void nsInputDeviceMouseKeyboard_GLFW::InitializeDevice() {}

void nsInputDeviceMouseKeyboard_GLFW::RegisterInputSlots()
{
...
void nsInputDeviceMouseKeyboard_GLFW::ResetInputSlotValues()
{
...
void nsInputDeviceMouseKeyboard_GLFW::OnKey(int key, int scancode, int action, int mods)
{
...
void nsInputDeviceMouseKeyboard_GLFW::OnCharacter(unsigned int codepoint)
{
  m_uiLastCharacter = codepoint;
}

void nsInputDeviceMouseKeyboard_GLFW::OnCursorPosition(double xpos, double ypos)
{
  s_pMouseOver = this;
...
void nsInputDeviceMouseKeyboard_GLFW::OnMouseButton(int button, int action, int mods)
{
...
void nsInputDeviceMouseKeyboard_GLFW::OnScroll(double xoffset, double yoffset)
{
  if (yoffset > 0)
  {
...
NS_STATICLINK_FILE(Core, Core_Platform_GLFW_InputDevice_GLFW);
