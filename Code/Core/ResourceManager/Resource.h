...
public:
  ...
  NS_ALWAYS_INLINE nsStringView GetResourceID() const { return m_sUniqueID; }
...
private:
  nsAtomicInteger<nsResourceState> m_LoadingState = nsResourceState::Unloaded;
  nsAtomicInteger<nsUInt8> m_uiQualityLevelsDiscardable = 0;
  nsAtomicInteger<nsUInt8> m_uiQualityLevelsLoadable = 0;
