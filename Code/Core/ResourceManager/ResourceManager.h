...
private:
  ...
  static void EnsureResourceCondition(nsResource* pResource, const nsDelegate<bool()>& condition);
  ...
  template <typename ResourceType, typename DescriptorType>
  static nsTypedResourceHandle<ResourceType> CreateResourceInternal(nsStringView sResourceID, DescriptorType&& descriptor, nsStringView sResourceDescription, bool bAllowGetFallback);
