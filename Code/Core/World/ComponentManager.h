...
template <typename ComponentType, nsComponentUpdateType::Enum UpdateType, nsBlockStorageType::Enum StorageType = nsBlockStorageType::FreeList, nsWorldUpdatePhase::Enum UpdatePhase = nsWorldUpdatePhase::PreAsync>
