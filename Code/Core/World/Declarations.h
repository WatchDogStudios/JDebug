...
struct nsObjectFlags
{
  ...
  enum Enum
  {
    ...
    HideShapeIcon = NS_BIT(14),                       ///< Hide the shape icon of the object in the editor.
...
NS_DECLARE_REFLECTABLE_TYPE(NS_CORE_DLL, nsComponentMode);
...
NS_DECLARE_REFLECTABLE_TYPE(NS_CORE_DLL, nsObjectMsgQueueType);
