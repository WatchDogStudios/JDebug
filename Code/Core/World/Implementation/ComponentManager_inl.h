...
{
  static_assert(NS_IS_DERIVED_FROM_STATIC(nsComponent, ComponentType), "Not a valid component type");
}
...
NS_FORCE_INLINE void nsComponentManager<T, StorageType>::RegisterUpdateFunction(UpdateFunctionDesc& desc)
{
  ...
  {
    desc.m_uiAsyncPhaseBatchSize = static_cast<nsUInt16>(nsMath::RoundUp(static_cast<nsInt32>(desc.m_uiAsyncPhaseBatchSize), nsDataBlock<ComponentType, nsInternal::DEFAULT_BLOCK_SIZE>::CAPACITY));
  }
...
template <typename ComponentType, nsComponentUpdateType::Enum UpdateType, nsBlockStorageType::Enum StorageType, nsWorldUpdatePhase::Enum UpdatePhase>
nsComponentManagerSimple<ComponentType, UpdateType, StorageType, UpdatePhase>::nsComponentManagerSimple(nsWorld* pWorld)
  : nsComponentManager<ComponentType, StorageType>(pWorld)
{
}

template <typename ComponentType, nsComponentUpdateType::Enum UpdateType, nsBlockStorageType::Enum StorageType, nsWorldUpdatePhase::Enum UpdatePhase>
void nsComponentManagerSimple<ComponentType, UpdateType, StorageType, UpdatePhase>::Initialize()
{
  using OwnType = nsComponentManagerSimple<ComponentType, UpdateType, StorageType, UpdatePhase>;
...
template <typename ComponentType, nsComponentUpdateType::Enum UpdateType, nsBlockStorageType::Enum StorageType, nsWorldUpdatePhase::Enum UpdatePhase>
void nsComponentManagerSimple<ComponentType, UpdateType, StorageType, UpdatePhase>::SimpleUpdate(const nsWorldModule::UpdateContext& context)
{
...
// static
template <typename ComponentType, nsComponentUpdateType::Enum UpdateType, nsBlockStorageType::Enum StorageType, nsWorldUpdatePhase::Enum UpdatePhase>
void nsComponentManagerSimple<ComponentType, UpdateType, StorageType, UpdatePhase>::SimpleUpdateName(nsStringBuilder& out_sName)
{
