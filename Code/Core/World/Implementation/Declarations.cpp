...
NS_BEGIN_STATIC_REFLECTED_ENUM(nsComponentMode, 1)
  NS_ENUM_CONSTANTS(nsComponentMode::Static, nsComponentMode::Dynamic)
NS_END_STATIC_REFLECTED_ENUM;

NS_BEGIN_STATIC_REFLECTED_ENUM(nsObjectMsgQueueType, 1)
  NS_ENUM_CONSTANTS(nsObjectMsgQueueType::PostAsync, nsObjectMsgQueueType::PostTransform, nsObjectMsgQueueType::NextFrame, nsObjectMsgQueueType::AfterInitialized)
NS_END_STATIC_REFLECTED_ENUM;
