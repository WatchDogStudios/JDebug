...
namespace nsInternal
{
...

  {
    ...
    static_assert(sizeof(nsGameObject::TransformationData) == 240);
#else
    static_assert(sizeof(nsGameObject::TransformationData) == 192);
#endif

    static_assert(sizeof(nsGameObject) == 128);
    static_assert(sizeof(QueuedMsgMetaData) == 16);
    static_assert(NS_COMPONENT_TYPE_INDEX_BITS <= sizeof(nsWorldModuleTypeId) * 8);
