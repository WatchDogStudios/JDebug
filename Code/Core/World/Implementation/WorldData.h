...
namespace nsInternal
{
  ...
  private:
    ...
    struct RegisteredUpdateFunction
    {
      ...
      float m_fPriority;
      nsUInt16 m_uiAsyncPhaseBatchSize;
    ...
    nsDynamicArray<RegisteredUpdateFunction, nsLocalAllocatorWrapper> m_UpdateFunctions[nsWorldUpdatePhase::COUNT];
    nsDynamicArray<nsWorldModule::UpdateFunctionDesc, nsLocalAllocatorWrapper> m_UpdateFunctionsToRegister;
    nsDynamicArray<nsWorldModule::UpdateFunctionDesc, nsLocalAllocatorWrapper> m_UpdateFunctionsToDeregister;
