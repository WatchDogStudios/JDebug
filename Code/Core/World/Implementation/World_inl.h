...
{
  static_assert(NS_IS_DERIVED_FROM_STATIC(nsWorldModule, ModuleType), "Not a valid module type");
...
{
  static_assert(NS_IS_DERIVED_FROM_STATIC(nsComponentManagerBase, ManagerType), "Not a valid component manager type");
