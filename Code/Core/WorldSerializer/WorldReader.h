...
public:
  ...
  nsStreamReader& GetStream() const;
...
private:
  ...
  nsStreamReader* m_pReadStream = nullptr;
  ...
  struct ComponentTypeInfo
  {
    ...
    nsUInt32 m_uiComponentDataSize = 0;
  };
  ...
  {
  public:
    InstantiationContext(nsWorldReader& ref_worldReader, nsWorld* pWorld, bool bUseTransform, const nsTransform& rootTransform, const nsPrefabInstantiationOptions& options);
