...
public:
  ...
  nsEnum<ConnectionState> GetConnectionState() const { return nsEnum<ConnectionState>(m_ConnectionState); }
...
protected:
  ...
  nsAtomicInteger<ConnectionState::Enum> m_ConnectionState = ConnectionState::Disconnected;
