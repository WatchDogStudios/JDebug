...
/// - Only need insertion/removal at one end (use nsDynamicArray)
/// - Need fastest possible element access (use nsDynamicArray)
/// - Memory usage is critical and size is predictable (use nsStaticArray or nsHybridArray)
