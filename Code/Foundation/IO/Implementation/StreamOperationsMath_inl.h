...
inline nsStreamWriter& operator<<(nsStreamWriter& inout_stream, nsFloat16 value)
{
  inout_stream.WriteWordValue(&value).AssertSuccess();
  return inout_stream;
}

inline nsStreamReader& operator>>(nsStreamReader& inout_stream, nsFloat16& ref_value)
{
