...
constexpr nsAngle operator*(const nsAngle& a, float f); // [tested]
/// \brief Returns f times angle a.
constexpr nsAngle operator*(float f, const nsAngle& a); // [tested]

/// \brief Returns the angle a divided by f.
constexpr nsAngle operator/(const nsAngle& a, float f); // [tested]
/// \brief Returns the fraction of angle a divided by angle b.
constexpr float operator/(const nsAngle& a, const nsAngle& b); // [tested]
