...
public:
  ...
  [[nodiscard]] static nsColor MakeNaN(); // [tested]
  ...
  [[nodiscard]] static nsColor MakeZero(); // [tested]

  /// \brief Returns a color with the given r, g, b, a values. The values must be given in a linear color space.
  [[nodiscard]] static nsColor MakeRGBA(float fLinearRed, float fLinearGreen, float fLinearBlue, float fLinearAlpha = 1.0f); // [tested]
...
public:
  ...
  [[nodiscard]] static nsColor MakeFromKelvin(nsUInt32 uiKelvin); // [tested]
  ...
  const nsVec4 GetAsVec4() const; // [tested]
...
public:
  ...
  nsColor GetDarker(float fFactor = 2.0f) const; // [tested]
...
public:
  ...
  nsColor WithAlpha(float fAlpha) const; // [tested]
  ...
  [[nodiscard]] nsUInt32 ToRGBA8() const; // [tested]
  ...
  [[nodiscard]] nsUInt32 ToABGR8() const; // [tested]
};
