...
constexpr inline nsAngle operator*(const nsAngle& a, float f)
{
  return nsAngle::MakeFromRadian(a.GetRadian() * f);
}

constexpr inline nsAngle operator*(float f, const nsAngle& a)
{
  return nsAngle::MakeFromRadian(a.GetRadian() * f);
}
...
constexpr inline float operator/(const nsAngle& a, const nsAngle& b)
{
