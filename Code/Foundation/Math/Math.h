...
namespace nsMath
{
  ...
  template <typename Type>
  [[nodiscard]] constexpr Type Bitmask_LowN(nsUInt32 uiNumBitsToSet); // [tested]

  /// \brief Creates a bitmask in which the high N bits are set. For example for N=5, this would be '1111 1000 ... 0000'
  ///
  /// For N >= 32 all bits will be set.
  template <typename Type>
  [[nodiscard]] constexpr Type Bitmask_HighN(nsUInt32 uiNumBitsToSet); // [tested]
  ...
  template <nsUInt32 NumBits>
  [[nodiscard]] constexpr float ColorUnsignedIntToFloat(nsUInt32 value);
  ...
  [[nodiscard]] T EvaluateBnsierCurve(T2 t, const T& startPoint, const T& controlPoint1, const T& controlPoint2, const T& endPoint); // [tested]
  ...
  /// Can be used with T as float, vec2, vec3 or vec4
  template <typename T, typename T2>
  [[nodiscard]] T EvaluateBnsierCurveDerivative(T2 t, const T& startPoint, const T& controlPoint1, const T& controlPoint2, const T& endPoint);
