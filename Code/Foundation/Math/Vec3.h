...
public:
  ...
  NS_DECLARE_IF_FLOAT_TYPE
  [[nodiscard]] static nsVec3Template<Type> MakeOrthogonalVector(const nsVec3Template<Type>& vDirection, const nsVec3Template<Type>& vBasis1 = MakeAxisX(), const nsVec3Template<Type>& vBasis2 = MakeAxisY()); // [tested]
...
public:
  ...
  nsAngle GetAngleBetween(const nsVec3Template<Type>& vForward, const nsVec3Template<Type>& vUp) const; // [tested]
