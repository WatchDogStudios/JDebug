...
///
/// This abstract base class defines the interface for all allocators in WDFramework. Allocators are responsible
...
///
/// Usage:
/// - Use NS_NEW/NS_DELETE macros instead of calling Allocate/Deallocate directly
...
public:
  ...
  ///
  /// This information is only available if allocation tracking is enabled (see nsAllocatorTrackingMode
  /// and NS_ALLOC_TRACKING_DEFAULT). Returns 0 when tracking is disabled or for invalid pointers.
