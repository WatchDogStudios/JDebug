...
/// if (abstractProp->GetSpecificType() == nsGetStaticRTTI<int>())
/// {
///   auto* intProp = static_cast<nsTypedMemberProperty<int>*>(abstractProp);
...
/// \brief Implementation of nsTypedMemberProperty that uses custom getter/setter functions to access a property.
///
...
/// \brief Implementation of nsTypedMemberProperty that provides direct access to member variables.
///
