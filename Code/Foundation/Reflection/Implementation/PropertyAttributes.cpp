...
// clang-format off
NS_BEGIN_DYNAMIC_REFLECTED_TYPE(nsSplineManipulatorAttribute, 1, nsRTTIDefaultAllocator<nsSplineManipulatorAttribute>)
{
  NS_BEGIN_FUNCTIONS
  {
    NS_CONSTRUCTOR_PROPERTY(const char*, const char*, const char*),
...
nsSplineManipulatorAttribute::nsSplineManipulatorAttribute()
  : nsManipulatorAttribute(nullptr)
{
}

nsSplineManipulatorAttribute::nsSplineManipulatorAttribute(const char* szNodesProperty, const char* szClosedProperty, const char* szBindTo)
  : nsManipulatorAttribute(szNodesProperty, szClosedProperty, szBindTo)
{
}
...
// clang-format off
NS_BEGIN_DYNAMIC_REFLECTED_TYPE(nsSplineTangentManipulatorAttribute, 1, nsRTTIDefaultAllocator<nsSplineTangentManipulatorAttribute>)
{
  NS_BEGIN_FUNCTIONS
  {
    NS_CONSTRUCTOR_PROPERTY(const char*, const char*),
...
nsSplineTangentManipulatorAttribute::nsSplineTangentManipulatorAttribute()
  : nsManipulatorAttribute(nullptr)
{
}

nsSplineTangentManipulatorAttribute::nsSplineTangentManipulatorAttribute(const char* szTangentMode, const char* szCustomTangent)
  : nsManipulatorAttribute(szTangentMode, szCustomTangent)
{
}
