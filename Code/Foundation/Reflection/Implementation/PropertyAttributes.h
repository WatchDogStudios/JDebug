...
public:
  ...
  nsFileBrowserAttribute(nsStringView sDialogTitle, nsStringView sTypeFilter, nsStringView sCustomAction = {}, nsStringView sCreateTitle = {}, nsBitflags<nsDependencyFlags> depencyFlags = nsDependencyFlags::Transform | nsDependencyFlags::Thumbnail)
  ...
  nsStringView GetCreateTitle() const { return m_sCreateTitle; }
...
private:
  ...
  nsUntrackedString m_sCreateTitle;
...
class NS_FOUNDATION_DLL nsSplineManipulatorAttribute : public nsManipulatorAttribute
{
  NS_ADD_DYNAMIC_REFLECTION(nsSplineManipulatorAttribute, nsManipulatorAttribute);

public:
  nsSplineManipulatorAttribute();
  nsSplineManipulatorAttribute(const char* szNodesProperty, const char* szClosedProperty, const char* szBindTo);

  const nsUntrackedString& GetNodesProperty() const { return m_sProperty1; }
  const nsUntrackedString& GetClosedProperty() const { return m_sProperty2; }
  const nsUntrackedString& GetBindTo() const { return m_sProperty3; }
};

//////////////////////////////////////////////////////////////////////////

class NS_FOUNDATION_DLL nsSplineTangentManipulatorAttribute : public nsManipulatorAttribute
{
  NS_ADD_DYNAMIC_REFLECTION(nsSplineTangentManipulatorAttribute, nsManipulatorAttribute);

public:
  nsSplineTangentManipulatorAttribute();
  nsSplineTangentManipulatorAttribute(const char* szTangentMode, const char* szCustomTangent);

  const nsUntrackedString& GetTangentModeProperty() const { return m_sProperty1; }
  const nsUntrackedString& GetCustomTangentProperty() const { return m_sProperty2; }
};
