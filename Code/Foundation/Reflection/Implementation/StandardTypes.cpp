...
NS_BEGIN_STATIC_REFLECTED_TYPE(nsTime, nsNoBase, 1, nsRTTINoAllocator)
{
  NS_BEGIN_FUNCTIONS
  {
    NS_SCRIPT_FUNCTION_PROPERTY(MakeFromNanoseconds, In, "Nanoseconds")->AddFlags(nsPropertyFlags::PureFunction),
    NS_SCRIPT_FUNCTION_PROPERTY(MakeFromMicroseconds, In, "Microseconds")->AddFlags(nsPropertyFlags::PureFunction),
    NS_SCRIPT_FUNCTION_PROPERTY(MakeFromMilliseconds, In, "Milliseconds")->AddFlags(nsPropertyFlags::PureFunction),
    NS_SCRIPT_FUNCTION_PROPERTY(MakeFromSeconds, In, "Seconds")->AddFlags(nsPropertyFlags::PureFunction),
    NS_SCRIPT_FUNCTION_PROPERTY(MakeFromMinutes, In, "Minutes")->AddFlags(nsPropertyFlags::PureFunction),
    NS_SCRIPT_FUNCTION_PROPERTY(MakeFromHours, In, "Hours")->AddFlags(nsPropertyFlags::PureFunction),
    NS_SCRIPT_FUNCTION_PROPERTY(MakeZero)->AddFlags(nsPropertyFlags::PureFunction),
...
NS_BEGIN_STATIC_REFLECTED_TYPE(nsColor, nsNoBase, 1, nsRTTINoAllocator)
{
  ...
  NS_BEGIN_FUNCTIONS
  {
    ...
    NS_SCRIPT_FUNCTION_PROPERTY(MakeRGBA, In, "R", In, "G", In, "B", In, "A")->AddFlags(nsPropertyFlags::PureFunction),
    NS_SCRIPT_FUNCTION_PROPERTY(MakeHSV, In, "Hue", In, "Saturation", In, "Value")->AddFlags(nsPropertyFlags::PureFunction),
  }
  NS_END_FUNCTIONS;
}
NS_END_STATIC_REFLECTED_TYPE;
...
NS_BEGIN_STATIC_REFLECTED_TYPE(nsVec3, nsNoBase, 1, nsRTTINoAllocator)
{
  ...
  NS_BEGIN_FUNCTIONS
  {
    NS_CONSTRUCTOR_PROPERTY(float),
    NS_CONSTRUCTOR_PROPERTY(float, float, float),
    NS_SCRIPT_FUNCTION_PROPERTY(Make, In, "X", In, "Y", In, "Z")->AddFlags(nsPropertyFlags::PureFunction),
...
NS_BEGIN_STATIC_REFLECTED_TYPE(nsQuat, nsNoBase, 1, nsRTTINoAllocator)
{
  ...
  {
    NS_CONSTRUCTOR_PROPERTY(float, float, float, float),
    NS_SCRIPT_FUNCTION_PROPERTY(MakeFromAxisAndAngle, In, "Axis", In, "Angle")->AddFlags(nsPropertyFlags::PureFunction),
    NS_SCRIPT_FUNCTION_PROPERTY(MakeShortestRotation, In, "DirFrom", In, "DirTo")->AddFlags(nsPropertyFlags::PureFunction),
    NS_SCRIPT_FUNCTION_PROPERTY(MakeSlerp, In, "From", In, "To", In, "Lerp")->AddFlags(nsPropertyFlags::PureFunction),
    NS_SCRIPT_FUNCTION_PROPERTY(MakeFromEulerAngles, In, "Roll", In, "Pitch", In, "Yaw")->AddFlags(nsPropertyFlags::PureFunction),
...
NS_BEGIN_STATIC_REFLECTED_TYPE(nsTransform, nsNoBase, 1, nsRTTINoAllocator)
{
  ...
  NS_BEGIN_FUNCTIONS
  {
    ...
    NS_SCRIPT_FUNCTION_PROPERTY(Make, In, "Position", In, "Rotation", In, "Scale")->AddFlags(nsPropertyFlags::PureFunction)->AddAttributes(
      new nsFunctionArgumentAttributes(2, new nsDefaultValueAttribute(nsVec3(1)))),
    NS_SCRIPT_FUNCTION_PROPERTY(MakeLocalTransform, In, "Parent", In, "GlobalChild")->AddFlags(nsPropertyFlags::PureFunction),
    NS_SCRIPT_FUNCTION_PROPERTY(MakeGlobalTransform, In, "Parent", In, "LocalChild")->AddFlags(nsPropertyFlags::PureFunction),
...
NS_BEGIN_STATIC_REFLECTED_TYPE(nsAngle, nsNoBase, 1, nsRTTINoAllocator)
{
  NS_BEGIN_FUNCTIONS
  {
    NS_SCRIPT_FUNCTION_PROPERTY(MakeFromDegree, In, "Degree")->AddFlags(nsPropertyFlags::PureFunction),
    NS_SCRIPT_FUNCTION_PROPERTY(MakeFromRadian, In, "Radian")->AddFlags(nsPropertyFlags::PureFunction),
