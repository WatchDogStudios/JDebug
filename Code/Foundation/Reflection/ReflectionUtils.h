...
///
/// This utility class provides high-level functions for working with WDFramework's reflection system.
...
///
/// Key functionality:
/// - Property value access and modification through nsVariant
...
public:
  ...
  ///
  /// Performs a deep comparison of all reflected properties. For classes derived from nsReflectedClass,
