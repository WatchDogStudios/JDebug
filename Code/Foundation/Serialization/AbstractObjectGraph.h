...
/// allowing for versioning, patching, and format conversion. It serves as the core of WDFramework's
...
///
/// Structure:
/// - Graph contains nodes (nsAbstractObjectNode) identified by GUIDs
/// - Each node has a type name, version, and properties
/// - Properties store values as nsVariant (including object references)
