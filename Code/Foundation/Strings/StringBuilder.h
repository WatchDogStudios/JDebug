...
public:
  ...
  void SetFormat(const nsFormatString& string); // [tested]
  ...
  void AppendFormat(const nsFormatString& string); // [tested]
  ...
  void PrependFormat(const nsFormatString& string); // [tested]
