...
void nsTaskWorkerThread::BroadcastClearThreadLocalsEvent()
{
...
void nsTaskWorkerThread::WaitForBroadcastClearTLS()
{
...
nsUInt32 nsTaskWorkerThread::Run()
{
  ...
  while (m_bActive)
  {
    if (m_bClearThreadLocalsEvent)
    {
      ...
      nsThreadEvent e;
      e.m_pThread = this;
      e.m_Type = nsThreadEvent::Type::ClearThreadLocals;
      nsThread::s_ThreadEvents.Broadcast(e);
    }
