...
constexpr NS_ALWAYS_INLINE nsTime operator*(const nsTime& t, double f)
{
  return nsTime::MakeFromSeconds(t.GetSeconds() * f);
}

constexpr NS_ALWAYS_INLINE nsTime operator*(double f, const nsTime& t)
{
  return nsTime::MakeFromSeconds(t.GetSeconds() * f);
}

constexpr NS_ALWAYS_INLINE nsTime operator*(const nsTime& f, const nsTime& t)
{
