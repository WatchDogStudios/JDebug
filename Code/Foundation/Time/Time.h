...
constexpr nsTime operator*(const nsTime& t, double f);
constexpr nsTime operator*(double f, const nsTime& t);
constexpr nsTime operator*(const nsTime& f, const nsTime& t); // not physically correct, but useful (should result in seconds squared)

constexpr nsTime operator/(const nsTime& t, double f);
constexpr nsTime operator/(double f, const nsTime& t);
constexpr nsTime operator/(const nsTime& f, const nsTime& t); // not physically correct, but useful (should result in a value without a unit)
