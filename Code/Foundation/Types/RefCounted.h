...
///
/// Extends nsRefCountingImpl with a virtual destructor, making it suitable as a base class
...
/// The contained object can be accessed via the m_Content member. Inherits from nsRefCounted
