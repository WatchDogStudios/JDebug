...
///
/// The WDFramework type trait system classifies types into three categories to enable
...
using nsTypeIsMemRelocatable = nsTraitInt<2>; ///< Types that can be moved with memcpy
using nsTypeIsPod = nsTraitInt<1>;            ///< Plain Old Data types
using nsTypeIsClass = nsTraitInt<0>;          ///< Standard class types
