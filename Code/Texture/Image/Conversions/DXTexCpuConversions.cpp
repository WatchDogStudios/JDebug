...
nsImageConversionEntry g_DXTexCpuConversions[] = {
  ...
  nsImageConversionEntry(nsImageFormat::R8G8B8A8_UNORM, nsImageFormat::BC1_UNORM, nsImageConversionFlags::Default, 100),
  nsImageConversionEntry(nsImageFormat::R8G8B8A8_UNORM, nsImageFormat::BC7_UNORM, nsImageConversionFlags::Default, 100),

  nsImageConversionEntry(nsImageFormat::R8G8B8A8_UNORM_SRGB, nsImageFormat::BC1_UNORM_SRGB, nsImageConversionFlags::Default, 100),
  nsImageConversionEntry(nsImageFormat::R8G8B8A8_UNORM_SRGB, nsImageFormat::BC7_UNORM_SRGB, nsImageConversionFlags::Default, 100),
};
...
NS_STATICLINK_FORCE static nsImageConversion_CompressDxTexCpu s_conversion_compressDxTexCpu;
