...
class nsImageConversionStep_Decompress16bpp : nsImageConversionStepLinear
{
  ...
  virtual nsResult ConvertPixels(nsConstByteBlobPtr source, nsByteBlobPtr target, nsUInt64 numElements, nsImageFormat::Enum sourceFormat, nsImageFormat::Enum targetFormat) const override
  {
...
struct nsImageSwizzleConversion32_2103 : public nsImageConversionStepLinear
{
  ...
  virtual nsResult ConvertPixels(nsConstByteBlobPtr source, nsByteBlobPtr target, nsUInt64 uiNumElements, nsImageFormat::Enum sourceFormat, nsImageFormat::Enum targetFormat) const override
  {
    NS_IGNORE_UNUSED(sourceFormat);
    NS_IGNORE_UNUSED(targetFormat);
