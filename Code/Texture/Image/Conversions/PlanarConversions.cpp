...
struct nsImageConversion_NV12_sRGB : public nsImageConversionStepDeplanarize
{
  ...
  virtual nsResult ConvertPixels(nsArrayPtr<nsImageView> source, nsImage target, nsUInt32 uiNumPixelsX, nsUInt32 uiNumPixelsY, nsImageFormat::Enum sourceFormat, nsImageFormat::Enum targetFormat) const override
  {
    NS_IGNORE_UNUSED(sourceFormat);
...
struct nsImageConversion_sRGB_NV12 : public nsImageConversionStepPlanarize
{
  ...
  virtual nsResult ConvertPixels(const nsImageView& source, nsArrayPtr<nsImage> target, nsUInt32 uiNumPixelsX, nsUInt32 uiNumPixelsY, nsImageFormat::Enum sourceFormat, nsImageFormat::Enum targetFormat) const override
  {
    NS_IGNORE_UNUSED(sourceFormat);
    NS_IGNORE_UNUSED(targetFormat);
...
NS_STATICLINK_FORCE static nsImageConversion_NV12_sRGB s_conversion_NV12_sRGB;
NS_STATICLINK_FORCE static nsImageConversion_sRGB_NV12 s_conversion_sRGB_NV12;
