...
NS_STATICLINK_FORCE static nsImageFileFormatRegistrator<nsBmpFileFormat> g_bmpFormat;
...
static_assert(sizeof(nsCIEXYZTRIPLE) == 3 * 3 * 4);

// just to be on the safe side
#if NS_ENABLED(NS_PLATFORM_WINDOWS)
static_assert(sizeof(nsCIEXYZTRIPLE) == sizeof(CIEXYZTRIPLE));
#endif
