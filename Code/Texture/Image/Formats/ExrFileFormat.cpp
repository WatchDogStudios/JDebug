...
NS_STATICLINK_FORCE static nsImageFileFormatRegistrator<nsExrFileFormat> g_ExrFileFormat;
...
{
  NS_IGNORE_UNUSED(ref_stream);
  NS_IGNORE_UNUSED(image);
  NS_IGNORE_UNUSED(sFileExtension);
