...
NS_STATICLINK_FORCE static nsImageFileFormatRegistrator<nsTgaFileFormat> g_TgaFormat;
...
static nsResult ReadImageHeaderImpl(nsStreamReader& inout_stream, nsImageHeader& ref_header, TgaHeader& ref_tgaHeader)
{
...
nsResult nsTgaFileFormat::ReadImage(nsStreamReader& inout_stream, nsImage& ref_image, nsStringView sFileExtension) const
{
  ...
  TgaHeader tgaHeader;
  NS_SUCCEED_OR_RETURN(ReadImageHeaderImpl(inout_stream, imageHeader, tgaHeader));
