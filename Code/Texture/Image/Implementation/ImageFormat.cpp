...
static void SetupImageFormatTable()
{
  ...
  {
    auto& meta = s_formatMetaData[nsImageFormat::NV12];

    meta.m_szName = "NV12";
    meta.m_formatType = nsImageFormatType::PLANAR;
    ...
    meta.m_planeData[0].m_subFormat = nsImageFormat::R8_UNORM;
    ...
    meta.m_planeData[1].m_subFormat = nsImageFormat::R8G8_UNORM;
  }

  {
    auto& meta = s_formatMetaData[nsImageFormat::P010];
    ...
    meta.m_planeData[0].m_uiBlockHeight = 1;
    meta.m_planeData[0].m_uiBlockDepth = 1;
    meta.m_planeData[0].m_subFormat = nsImageFormat::R16_UNORM;

    meta.m_planeData[1].m_uiBitsPerBlock = 20;
    meta.m_planeData[1].m_uiBlockWidth = 2;
    meta.m_planeData[1].m_uiBlockHeight = 2;
    meta.m_planeData[1].m_uiBlockDepth = 1;
    meta.m_planeData[1].m_subFormat = nsImageFormat::R16G16_UNORM;
  }
}
