...
static void RegisterScriptArray_Native(asIScriptEngine *engine)
{
  ...
  // vvv NS SPECIFIC CHANGES IN THIS FUNCTION vvv
	...
	r = engine->RegisterObjectMethod("array<T>", "T& PeekBack()", asMETHODPR(CScriptArray, PeekBack, (), void*), asCALL_THISCALL); assert( r >= 0 );
	r = engine->RegisterObjectMethod("array<T>", "const T& PeekBack() const", asMETHODPR(CScriptArray, PeekBack, () const, const void*), asCALL_THISCALL); assert( r >= 0 );

	r = engine->RegisterObjectMethod("array<T>", "T& ExpandAndGetRef()", asMETHODPR(CScriptArray, ExpandAndGetRef, (), void*), asCALL_THISCALL); assert( r >= 0 );
	...
	r = engine->RegisterObjectMethod("array<T>", "void InsertRangeAt(uint index, const array<T>& arr)", asMETHODPR(CScriptArray, InsertAt, (asUINT, const CScriptArray &), void), asCALL_THISCALL); assert(r >= 0);
	r = engine->RegisterObjectMethod("array<T>", "void PushBack(const T&in value)", asMETHOD(CScriptArray, InsertLast), asCALL_THISCALL); assert(r >= 0);
	r = engine->RegisterObjectMethod("array<T>", "void RemoveAtAndCopy(uint index)", asMETHOD(CScriptArray, RemoveAt), asCALL_THISCALL); assert(r >= 0);
	r = engine->RegisterObjectMethod("array<T>", "void PopBack()", asMETHOD(CScriptArray, RemoveLast), asCALL_THISCALL); assert( r >= 0 );
	r = engine->RegisterObjectMethod("array<T>", "void RemoveAtAndCopy(uint start, uint count)", asMETHOD(CScriptArray, RemoveRange), asCALL_THISCALL); assert(r >= 0);
	...
	r = engine->RegisterObjectMethod("array<T>", "uint GetCount() const", asMETHOD(CScriptArray, GetSize), asCALL_THISCALL); assert( r >= 0 );
#endif
	r = engine->RegisterObjectMethod("array<T>", "void Reserve(uint length)", asMETHOD(CScriptArray, Reserve), asCALL_THISCALL); assert( r >= 0 );
	r = engine->RegisterObjectMethod("array<T>", "void SetCount(uint length)", asMETHODPR(CScriptArray, Resize, (asUINT), void), asCALL_THISCALL); assert( r >= 0 );
  r = engine->RegisterObjectMethod("array<T>", "void Clear()", asMETHODPR(CScriptArray, Clear, (), void), asCALL_THISCALL); assert( r >= 0 );
	...
	r = engine->RegisterObjectMethod("array<T>", "int IndexOf(const T&in if_handle_then_const value) const", asMETHODPR(CScriptArray, Find, (const void*) const, int), asCALL_THISCALL); assert( r >= 0 );
	r = engine->RegisterObjectMethod("array<T>", "bool Contains(const T&in if_handle_then_const value) const", asMETHODPR(CScriptArray, Contains, (const void*) const, bool), asCALL_THISCALL); assert( r >= 0 );
	// TODO: It should be "int find(const T&in value, uint startAt = 0) const"
	r = engine->RegisterObjectMethod("array<T>", "int IndexOf(uint startAt, const T&in if_handle_then_const value) const", asMETHODPR(CScriptArray, Find, (asUINT, const void*) const, int), asCALL_THISCALL); assert( r >= 0 );
	r = engine->RegisterObjectMethod("array<T>", "int IndexOfByRef(const T&in if_handle_then_const value) const", asMETHODPR(CScriptArray, FindByRef, (const void*) const, int), asCALL_THISCALL); assert( r >= 0 );
	// TODO: It should be "int findByRef(const T&in value, uint startAt = 0) const"
	r = engine->RegisterObjectMethod("array<T>", "int IndexOfByRef(uint startAt, const T&in if_handle_then_const value) const", asMETHODPR(CScriptArray, FindByRef, (asUINT, const void*) const, int), asCALL_THISCALL); assert( r >= 0 );
  ...
  // ^^^ NS SPECIFIC CHANGES IN THIS FUNCTION ^^^
}
