...
### [nsEditor](https://github.com/WDFramework/WDFramework)

The nsEditor is a full blown graphical editor used for editing scenes and
importing and authoring assets for the [WDFramework](https://github.com/WDFramework/WDFramework) -
an open source C++ game engine in active development.

![nsEditor](doc/showcase_WDFramework_editor.png)
