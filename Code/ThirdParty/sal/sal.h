...
#define _Post_maybns_ _SAL1_1_Source_(_Post_maybns_, (), _Post1_impl_(__maybnsterm_impl))
...
#  define __maybnsterm_impl NullTerminated = SA_Maybe
...
#  define __maybnsterm_impl _SA_annotes1(SAL_nullTerminated, __maybe)
