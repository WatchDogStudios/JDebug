  ...
  : QMainWindow()
{
  ...
  nsQtMainWidget* pMainWidget = new nsQtMainWidget(m_DockManager);
  nsQtLogDockWidget* pLogWidget = new nsQtLogDockWidget(m_DockManager);
  nsQtMemoryWidget* pMemoryWidget = new nsQtMemoryWidget(m_DockManager);
  nsQtTimeWidget* pTimeWidget = new nsQtTimeWidget(m_DockManager);
  nsQtInputWidget* pInputWidget = new nsQtInputWidget(m_DockManager);
  nsQtCVarsWidget* pCVarsWidget = new nsQtCVarsWidget(m_DockManager);
  nsQtSubsystemsWidget* pSubsystemsWidget = new nsQtSubsystemsWidget(m_DockManager);
  nsQtFileWidget* pFileWidget = new nsQtFileWidget(m_DockManager);
  nsQtPluginsWidget* pPluginsWidget = new nsQtPluginsWidget(m_DockManager);
  nsQtGlobalEventsWidget* pGlobalEventesWidget = new nsQtGlobalEventsWidget(m_DockManager);
  nsQtReflectionWidget* pReflectionWidget = new nsQtReflectionWidget(m_DockManager);
  nsQtDataWidget* pDataWidget = new nsQtDataWidget(m_DockManager);
  nsQtResourceWidget* pResourceWidget = new nsQtResourceWidget(m_DockManager);
  ...
  {
    m_pStatHistoryWidgets[i] = new nsQtStatVisWidget(m_DockManager, this, i);
