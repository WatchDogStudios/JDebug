...
public:
  ...
  static nsActionDescriptorHandle GetActionHandle(nsStringView sCategory, nsStringView sActionName);
  ...
  /// string.
  static nsString FindActionCategory(nsStringView sActionName);
  ...
  static nsResult ExecuteAction(nsStringView sCategory, nsStringView sActionName, const nsActionContext& context, const nsVariant& value = nsVariant());
...
private:
  ...
  struct CategoryData
  {
    ...
    nsHashTable<nsStringView, nsActionDescriptorHandle> m_ActionNameToHandle;
  };
