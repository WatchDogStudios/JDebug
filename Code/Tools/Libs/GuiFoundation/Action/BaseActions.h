...
/// Or use something like nsEnumerationMenuAction to get a menu for an enum type.
...
public:
  ...
  virtual void GetEntries(nsDynamicArray<Item>& out_entries) = 0;
};
...
public:
  ...
  virtual void GetEntries(nsDynamicArray<Item>& out_entries) override;
