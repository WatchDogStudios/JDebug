...
nsActionDescriptorHandle nsActionManager::GetActionHandle(nsStringView sCategoryPath, nsStringView sActionName)
{
...
nsString nsActionManager::FindActionCategory(nsStringView sActionName)
{
...
nsResult nsActionManager::ExecuteAction(nsStringView sCategory0, nsStringView sActionName, const nsActionContext& context, const nsVariant& value /*= nsVariant()*/)
{
  nsStringBuilder sCategory = sCategory0;
  ...
  auto hAction = nsActionManager::GetActionHandle(sCategory, sActionName);
