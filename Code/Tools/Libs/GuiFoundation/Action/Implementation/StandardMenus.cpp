...
nsActionDescriptorHandle nsStandardMenus::s_hMenuAsset;
...
nsActionDescriptorHandle nsStandardMenus::s_hAskQuestion;
...
void nsStandardMenus::RegisterActions()
{
  ...
  s_hMenuAsset = NS_REGISTER_MENU("G.Asset");
  ...
  s_hAskQuestion = NS_REGISTER_ACTION_1("Help.AskQuestion", nsActionScope::Global, "Help", "", nsHelpActions, nsHelpActions::ButtonType::AskQuestion);
}
...
void nsStandardMenus::UnregisterActions()
{
  ...
  nsActionManager::UnregisterAction(s_hMenuAsset);
  ...
  nsActionManager::UnregisterAction(s_hAskQuestion);
}
...
void nsStandardMenus::MapActions(nsStringView sMapping, const nsBitflags<nsStandardMenuTypes>& menus)
{
  ...
  if (menus.IsAnySet(nsStandardMenuTypes::Asset))
...
void nsApplicationPanelsMenuAction::GetEntries(nsDynamicArray<Item>& out_entries)
{
  out_entries.Clear();
...
void nsHelpActions::Execute(const nsVariant& value)
{
  ...
  {
    QDesktopServices::openUrl(QUrl("https://github.com/WDFramework/WDFramework/issues"));
  }
  else if (m_ButtonType == ButtonType::AskQuestion)
  {
    QDesktopServices::openUrl(QUrl("https://github.com/WDFramework/WDFramework/discussions"));
  }
