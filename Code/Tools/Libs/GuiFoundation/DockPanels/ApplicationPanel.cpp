...
nsQtApplicationPanel::nsQtApplicationPanel(ads::CDockManager* pDockManager, const char* szPanelName)
  : ads::CDockWidget(pDockManager, szPanelName, nsQtContainerWindow::GetContainerWindow())
{
