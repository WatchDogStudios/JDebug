...
public:
  ...
  nsDefaultObjectState(const nsRTTI* pType, nsObjectAccessorBase* pAccessor, const nsArrayPtr<nsPropertySelection> selection);
...
public:
  ...
  nsDefaultContainerState(const nsRTTI* pType, nsObjectAccessorBase* pAccessor, const nsArrayPtr<nsPropertySelection> selection, const char* szProperty);
