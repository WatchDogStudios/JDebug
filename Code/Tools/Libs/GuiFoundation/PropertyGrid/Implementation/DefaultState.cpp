...
NS_BEGIN_SUBSYSTEM_DECLARATION(GuiFoundation, DefaultState)
  ON_CORESYSTEMS_STARTUP
  {
    ...
    nsDefaultState::RegisterDefaultStateProvider(nsVariantSubDefaultStateProvider::CreateProvider);
  }
  ...
  ON_CORESYSTEMS_SHUTDOWN
  {
    ...
    nsDefaultState::UnregisterDefaultStateProvider(nsVariantSubDefaultStateProvider::CreateProvider);
  }
...
nsDefaultObjectState::nsDefaultObjectState(const nsRTTI* pType, nsObjectAccessorBase* pAccessor, const nsArrayPtr<nsPropertySelection> selection)
{
  m_pType = pType;
...
{
  const nsAbstractProperty* pProp = m_pType->FindPropertyByName(szProperty);
...
nsDefaultContainerState::nsDefaultContainerState(const nsRTTI* pType, nsObjectAccessorBase* pAccessor, const nsArrayPtr<nsPropertySelection> selection, const char* szProperty)
{
  m_pType = pType;
  m_pAccessor = pAccessor;
  m_Selection = selection;
