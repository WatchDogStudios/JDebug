...
static nsQtPropertyWidget* StandardTypeCreator(const nsRTTI* pRtti)
{
  ...
  switch (pRtti->GetVariantType())
  {
    ...
    case nsVariant::Type::Transform:
      return new nsQtPropertyEditorTransformWidget();
...
static nsQtPropertyWidget* VariantArrayCreator(const nsRTTI* pRtti)
{
...
NS_BEGIN_SUBSYSTEM_DECLARATION(GuiFoundation, PropertyGrid)
  ...
  ON_CORESYSTEMS_STARTUP
  {
    ...
    nsQtPropertyGridWidget::GetFactory().RegisterCreator(nsGetStaticRTTI<nsTransform>(), StandardTypeCreator);
    ...
    //nsQtPropertyGridWidget::GetFactory().RegisterCreator(nsGetStaticRTTI<nsVariantArray>(), VariantArrayCreator);
  ...
  ON_CORESYSTEMS_SHUTDOWN
  {
    ...
    nsQtPropertyGridWidget::GetFactory().UnregisterCreator(nsGetStaticRTTI<nsTransform>());
    ...
    //nsQtPropertyGridWidget::GetFactory().UnregisterCreator(nsGetStaticRTTI<nsVariantArray>());
...
nsQtPropertyGridWidget::nsQtPropertyGridWidget(QWidget* pParent, nsDocument* pDocument, bool bBindToSelectionManager)
  : QWidget(pParent)
{
  setObjectName("nsQtPropertyGridWidget");
...
void nsQtPropertyGridWidget::SelectionEventHandler(const nsSelectionManagerEvent& e)
{
  ...
  switch (e.m_Type)
  {
    ...
    case nsSelectionManagerEvent::Type::ChangedRuntimeOverrideSelection:
      // ignore
      break;
  }
}
