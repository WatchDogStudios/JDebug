...
class NS_GUIFOUNDATION_DLL nsQtPropertyEditorTransformWidget : public nsQtStandardPropertyWidget
{
  Q_OBJECT

public:
  nsQtPropertyEditorTransformWidget();
