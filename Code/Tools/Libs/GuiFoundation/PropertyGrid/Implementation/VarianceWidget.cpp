...
void nsQtVarianceTypeWidget::OnInit()
{
  ...
  {
    if (pClamp->GetMinValue().CanConvertTo<double>() || pClamp->GetMinValue().IsA<nsTime>() || pClamp->GetMinValue().IsA<nsAngle>())
    {
  ...
  {
    if (pDefault->GetValue().CanConvertTo<double>() || pDefault->GetValue().IsA<nsTime>() || pDefault->GetValue().IsA<nsAngle>())
    {
