...
nsResult nsQtUiServices::OpenFileInDefaultProgram(const char* szPath)
{
  return QDesktopServices::openUrl(QUrl::fromLocalFile(szPath)) ? NS_SUCCESS : NS_FAILURE;
}

nsResult nsQtUiServices::OpenInVisualStudio(const char* szPath)
{
  QString sVSExe;
...
nsResult nsQtUiServices::OpenInRider(const char* szPath)
{
  QString sRiderPath;
