...
public:
  ...
  static nsResult OpenFileInDefaultProgram(const char* szPath);

  /// \brief Open the given file in Visual Studio
  static nsResult OpenInVisualStudio(const char* szPath);

  /// \brief Open the given file in Jetbrains Rider
  static nsResult OpenInRider(const char* szPath);
