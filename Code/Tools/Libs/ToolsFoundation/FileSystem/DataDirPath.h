...
///
///  GetAbsolutePath() == "C:/WDFramework/Data/Samples/Testing Chambers/Objects/Barrel.nsPrefab"
///  GetDataDir() == "C:/WDFramework/Data/Samples/Testing Chambers"
...
public:
  ...
  /// \brief Returns absolute path to the data directory this path belongs to, e.g.  "C:/WDFramework/Data/Samples/Testing Chambers".
