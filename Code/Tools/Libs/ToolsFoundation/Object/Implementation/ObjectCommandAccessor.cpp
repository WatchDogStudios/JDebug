...
// clang-format off
NS_BEGIN_DYNAMIC_REFLECTED_TYPE(nsObjectCommandAccessor, 1, nsRTTINoAllocator)
...
nsStatus nsObjectCommandAccessor::AddObject(const nsDocumentObject* pParent, const nsAbstractProperty* pParentProp, const nsVariant& index, const nsRTTI* pType, nsUuid& inout_objectGuid)
{
