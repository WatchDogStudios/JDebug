...
{
  nsPlugin::Events().AddEventHandler(nsReflectedTypeStorageManager::PluginEventHandler);
...
void nsReflectedTypeStorageManager::Shutdown()
{
  ...
  nsPlugin::Events().RemoveEventHandler(nsReflectedTypeStorageManager::PluginEventHandler);
...
void nsReflectedTypeStorageManager::PluginEventHandler(const nsPluginEvent& EventData)
{
