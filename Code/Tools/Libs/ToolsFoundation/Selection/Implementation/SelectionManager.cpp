...
void nsSelectionManager::SetRuntimeOverrideSelection(const nsDeque<const nsDocumentObject*>& selection)
{
...

  {
    ...
    e.m_pDocument = GetDocument();
    e.m_pObject = nullptr;
    e.m_Type = nsSelectionManagerEvent::Type::ChangedRuntimeOverrideSelection;
    m_pSelectionStorage->m_Events.Broadcast(e);
  }
}
