...
/// \brief A collection of nsPathPatterns for include/exclude filtering of file paths.
struct NS_TOOLSFOUNDATION_DLL nsPathPatternFilter
{
  ...
  bool PassesFilters(nsStringView sText, nsStringBuilder* pMatchingFilter = nullptr) const;
};
