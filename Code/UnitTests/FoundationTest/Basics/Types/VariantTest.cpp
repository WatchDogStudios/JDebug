...
inline void TestNumberCanConvertTo(const nsVariant& v)
{
  ...
  NS_TEST_BOOL(v.CanConvertTo(nsVariant::Type::Vector2));
  NS_TEST_BOOL(v.CanConvertTo(nsVariant::Type::Vector3));
  NS_TEST_BOOL(v.CanConvertTo(nsVariant::Type::Vector4));
  NS_TEST_BOOL(v.CanConvertTo(nsVariant::Type::Vector2I));
  NS_TEST_BOOL(v.CanConvertTo(nsVariant::Type::Vector3I));
  NS_TEST_BOOL(v.CanConvertTo(nsVariant::Type::Vector4I));
  ...
  NS_TEST_BOOL(v.ConvertTo<nsVec2>(&conversionResult) == nsVec2(3));
  NS_TEST_BOOL(conversionResult.Succeeded());

  NS_TEST_BOOL(v.ConvertTo<nsVec3>(&conversionResult) == nsVec3(3));
  NS_TEST_BOOL(conversionResult.Succeeded());

  NS_TEST_BOOL(v.ConvertTo<nsVec4>(&conversionResult) == nsVec4(3));
  NS_TEST_BOOL(conversionResult.Succeeded());

  NS_TEST_BOOL(v.ConvertTo<nsVec2I32>(&conversionResult) == nsVec2I32(3));
  NS_TEST_BOOL(conversionResult.Succeeded());

  NS_TEST_BOOL(v.ConvertTo<nsVec3I32>(&conversionResult) == nsVec3I32(3));
  NS_TEST_BOOL(conversionResult.Succeeded());

  NS_TEST_BOOL(v.ConvertTo<nsVec4I32>(&conversionResult) == nsVec4I32(3));
  NS_TEST_BOOL(conversionResult.Succeeded());
  ...
  NS_TEST_BOOL(v.ConvertTo(nsVariant::Type::Vector2) == nsVec2(3));
  NS_TEST_BOOL(v.ConvertTo(nsVariant::Type::Vector3) == nsVec3(3));
  NS_TEST_BOOL(v.ConvertTo(nsVariant::Type::Vector4) == nsVec4(3));
  NS_TEST_BOOL(v.ConvertTo(nsVariant::Type::Vector2I) == nsVec2I32(3));
  NS_TEST_BOOL(v.ConvertTo(nsVariant::Type::Vector3I) == nsVec3I32(3));
  NS_TEST_BOOL(v.ConvertTo(nsVariant::Type::Vector4I) == nsVec4I32(3));
...
NS_CREATE_SIMPLE_TEST(Basics, Variant)
{
  ...
  NS_TEST_BLOCK(nsTestBlock::Enabled, "nsTypedObject inline")
  {
    ...
    nsVarianceTypeAngle value(nsAngle::MakeFromRadian(1.57079637f), 0.1f);
    ...
    nsVarianceTypeAngle* pTypedAngle = NS_DEFAULT_NEW(nsVarianceTypeAngle, nsAngle::MakeFromRadian(1.57079637f), 0.1f);
    nsVariant copy;
  ...
  NS_TEST_BLOCK(nsTestBlock::Enabled, "(Can)ConvertTo (bool)")
  {
    ...
    NS_TEST_BOOL(v.ConvertTo<nsVec2>() == nsVec2(1));
    NS_TEST_BOOL(v.ConvertTo<nsVec3>() == nsVec3(1));
    NS_TEST_BOOL(v.ConvertTo<nsVec4>() == nsVec4(1));
    NS_TEST_BOOL(v.ConvertTo<nsVec2I32>() == nsVec2I32(1));
    NS_TEST_BOOL(v.ConvertTo<nsVec3I32>() == nsVec3I32(1));
    NS_TEST_BOOL(v.ConvertTo<nsVec4I32>() == nsVec4I32(1));
