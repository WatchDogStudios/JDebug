...
{
  nsUniquePtr<nsIpcChannel> pServer = nsIpcChannel::CreatePipeChannel("WDFramework_unit_test_channel", nsIpcChannel::Mode::Server);
  nsUniquePtr<ChannelTester> pServerTester = NS_DEFAULT_NEW(ChannelTester, pServer.Borrow(), true);

  nsUniquePtr<nsIpcChannel> pClient = nsIpcChannel::CreatePipeChannel("WDFramework_unit_test_channel", nsIpcChannel::Mode::Client);
  nsUniquePtr<ChannelTester> pClientTester = NS_DEFAULT_NEW(ChannelTester, pClient.Borrow(), false);
