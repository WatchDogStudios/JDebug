...
NS_CREATE_SIMPLE_TEST(Math, BoundingBoxSphere)
{
  NS_TEST_BLOCK(nsTestBlock::Enabled, "Constructor")
  {
    ...
    NS_TEST_BOOL(b.m_vBoxHalfExtents == nsVec3T(1, 2, 3));
    ...
    NS_TEST_BOOL(b.m_vBoxHalfExtents == nsVec3T(1, 1, 1));
  ...
  NS_TEST_BLOCK(nsTestBlock::Enabled, "SetFromPoints")
  {
    ...
    NS_TEST_BOOL(b.m_vBoxHalfExtents == nsVec3T(4.5, 6.5, 8.5));
    NS_TEST_FLOAT(b.m_fSphereRadius, nsVec3T(0.5, 0.5, 8.5).GetLength(), 0.00001f);
    NS_TEST_BOOL(b.m_fSphereRadius <= b.m_vBoxHalfExtents.GetLength());
  }
  ...
  NS_TEST_BLOCK(nsTestBlock::Enabled, "ExpandToInclude")
  {
    ...
    NS_TEST_BOOL(b1.m_vBoxHalfExtents == nsVec3T(2, 2, 2));
    NS_TEST_FLOAT(b1.m_fSphereRadius, nsMath::Sqrt(nsMathTestType(3)) * 2, 0.00001f);
    NS_TEST_BOOL(b1.m_fSphereRadius <= b1.m_vBoxHalfExtents.GetLength());
  ...
  NS_TEST_BLOCK(nsTestBlock::Enabled, "Transform")
  {
    ...
    NS_TEST_BOOL(b.m_vBoxHalfExtents == nsVec3T(10, 15, 10));
  ...
  NS_TEST_BLOCK(nsTestBlock::Enabled, "IsNaN")
  {
    if (nsMath::SupportsNaN<nsMathTestType>())
    {
      ...
      b = nsBoundingBoxSphereT::MakeInvalid();
      b.m_vBoxHalfExtents.x = nsMath::NaN<nsMathTestType>();
      NS_TEST_BOOL(b.IsNaN());

      b = nsBoundingBoxSphereT::MakeInvalid();
      b.m_vBoxHalfExtents.y = nsMath::NaN<nsMathTestType>();
      NS_TEST_BOOL(b.IsNaN());

      b = nsBoundingBoxSphereT::MakeInvalid();
      b.m_vBoxHalfExtents.z = nsMath::NaN<nsMathTestType>();
      NS_TEST_BOOL(b.IsNaN());
