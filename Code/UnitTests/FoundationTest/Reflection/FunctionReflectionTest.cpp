...
struct FunctionTest
{
  ...
  nsVarianceTypeAngle CustomTypeFunction(nsVarianceTypeAngle v, const nsVarianceTypeAngle cv, nsVarianceTypeAngle& ref_rv, const nsVarianceTypeAngle& crv, nsVarianceTypeAngle* pPv, const nsVarianceTypeAngle* pCpv)
  {
    ...
    ref_rv = nsVarianceTypeAngle(nsAngle::MakeFromDegree(200.0f), 2.0f);
    if (pPv)
    {
      *pPv = nsVarianceTypeAngle(nsAngle::MakeFromDegree(400.0f), 4.0f);
    }
    return nsVarianceTypeAngle(nsAngle::MakeFromDegree(60.0f), 0.6f);
  }
...
NS_CREATE_SIMPLE_TEST(Reflection, Functions)
{
  ...
  NS_TEST_BLOCK(nsTestBlock::Enabled, "Member Functions - CustomType")
  {
    ...
    {
      FunctionTest test;
      test.m_values.PushBack(nsVarianceTypeAngle(nsAngle::MakeFromDegree(0.0f), 0.0f));
      test.m_values.PushBack(nsVarianceTypeAngle(nsAngle::MakeFromDegree(10.0f), 0.1f));
      test.m_values.PushBack(nsVarianceTypeAngle(nsAngle::MakeFromDegree(20.0f), 0.2f));
      test.m_values.PushBack(nsVarianceTypeAngle(nsAngle::MakeFromDegree(30.0f), 0.3f));
      test.m_values.PushBack(nsVarianceTypeAngle(nsAngle::MakeFromDegree(40.0f), 0.4f));
      test.m_values.PushBack(nsVarianceTypeAngle(nsAngle::MakeFromDegree(50.0f), 0.5f));

      nsVariant ret;
      funccall.Execute(&test, test.m_values, ret);
      NS_TEST_BOOL(ret.GetType() == nsVariantType::TypedObject);
      NS_TEST_BOOL(ret == nsVariant(nsVarianceTypeAngle(nsAngle::MakeFromDegree(60.0f), 0.6f)));
      NS_TEST_BOOL(test.m_values[2] == nsVariant(nsVarianceTypeAngle(nsAngle::MakeFromDegree(200.0f), 2.0f)));
      NS_TEST_BOOL(test.m_values[4] == nsVariant(nsVarianceTypeAngle(nsAngle::MakeFromDegree(400.0f), 4.0f)));
...

    {
      ...
      FunctionTest test;
      nsVarianceTypeAngle v0(nsAngle::MakeFromDegree(0.0f), 0.0f);
      nsVarianceTypeAngle v1(nsAngle::MakeFromDegree(10.0f), 0.1f);
      nsVarianceTypeAngle v2(nsAngle::MakeFromDegree(20.0f), 0.2f);
      nsVarianceTypeAngle v3(nsAngle::MakeFromDegree(30.0f), 0.3f);
      nsVarianceTypeAngle v4(nsAngle::MakeFromDegree(40.0f), 0.4f);
      nsVarianceTypeAngle v5(nsAngle::MakeFromDegree(50.0f), 0.5f);
      ...
      NS_TEST_BOOL(ret.GetType() == nsVariantType::TypedObject);
      NS_TEST_BOOL(ret == nsVariant(nsVarianceTypeAngle(nsAngle::MakeFromDegree(60.0f), 0.6f)));
      NS_TEST_BOOL((*test.m_values[2].Get<nsVarianceTypeAngle*>() == nsVarianceTypeAngle(nsAngle::MakeFromDegree(200.0f), 2.0f)));
      NS_TEST_BOOL((*test.m_values[4].Get<nsVarianceTypeAngle*>() == nsVarianceTypeAngle(nsAngle::MakeFromDegree(400.0f), 4.0f)));
