...
NS_CREATE_SIMPLE_TEST(Reflection, MemberProperties)
{
  NS_TEST_BLOCK(nsTestBlock::Enabled, "nsTestStruct")
  {
    ...
    nsVarianceTypeAngle expectedVA(nsAngle::MakeFromDegree(90.0f), 0.5f);
    nsVarianceTypeAngle testVA(nsAngle::MakeFromDegree(45.0f), 0.1f);
...
NS_CREATE_SIMPLE_TEST(Reflection, Arrays)
{
  ...
  {
    nsVarianceTypeAngle data(nsAngle::MakeFromDegree(45.0f), 0.1f);
...
NS_CREATE_SIMPLE_TEST(Reflection, Sets)
{
  ...
  {
    nsVarianceTypeAngle value1(nsAngle::MakeFromDegree(-45.0f), -0.1f);
    nsVarianceTypeAngle value2(nsAngle::MakeFromDegree(45.0f), 0.1f);
    ...
    nsVarianceTypeAngle value3(nsAngle::MakeFromDegree(-90.0f), -0.2f);
    nsVarianceTypeAngle value4(nsAngle::MakeFromDegree(90.0f), 0.2f);
