...
class NS_TEST_DLL nsRegisterTestHelper : public nsEnumerable<nsRegisterTestHelper>
{
  NS_DECLARE_ENUMERABLE_CLASS(nsRegisterTestHelper);

public:
  nsRegisterTestHelper() = default;
  virtual ~nsRegisterTestHelper() = default;
  virtual void RegisterTest() = 0;
};

class NS_TEST_DLL nsRegisterSimpleTestHelper : public nsRegisterTestHelper
{
public:
