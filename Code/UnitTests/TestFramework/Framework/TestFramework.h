...
#define NS_TEST_STATUS(condition)                    \
  ...
  nsTestResult(NS_PP_CONCAT(l_, NS_SOURCE_LINE).GetResult(), "Test failed: " NS_PP_STRINGIFY(condition), NS_SOURCE_FILE, NS_SOURCE_LINE, NS_SOURCE_FUNCTION, NS_PP_CONCAT(l_, NS_SOURCE_LINE).GetMessageString())
