...
{
  const nsStringView sFilePathView = "C:/Code/WDFramework/Data/Samples/Testing Chambers/Objects/Barrel.nsPrefab"_nssv;
  const nsStringView sDataDirView = "C:/Code/WDFramework/Data/Samples/Testing Chambers"_nssv;
  ...
  {
    nsString sFilePathView = "/Code/WDFramework/Data/Samples/Testing Chambers/Objects/Barrel.nsPrefab"_nssv;
    nsString sFilePath = sFilePathView;
    auto sDataDir = "/Code/WDFramework/Data/Samples/Testing Chambers"_nssv;
    nsHybridArray<nsString, 2> rootFolders;
  ...
  {
    nsString sDataDirView = (const char*)u8"/Code/WDFramework/Data/Sämples/Testing Chämbers";
    nsHybridArray<nsString, 2> rootFolders;
    rootFolders.PushBack(sDataDirView);
...
{
  auto* pForceNonNTFS = static_cast<nsCVarBool*>(nsCVar::FindCVarByName("Platform.DirectoryWatcher.ForceNonNTFS"));
  *pForceNonNTFS = true;
  FileSystemModelTest();
  *pForceNonNTFS = false;
}
