...
NS_CREATE_SIMPLE_TEST(DocumentObject, DocumentObjectManager)
{
  ...
  {
    NS_TEST_BOOL(manager.CanAdd(nsObjectTest::GetStaticRTTI(), nullptr, "", 0).Succeeded());
    ...
    NS_TEST_BOOL(manager.CanAdd(OuterClass::GetStaticRTTI(), pObject, szProperty, 0).Failed());
    NS_TEST_BOOL(manager.CanAdd(nsObjectTest::GetStaticRTTI(), pObject, szProperty, 0).Succeeded());
    ...
    NS_TEST_BOOL(manager.CanAdd(OuterClass::GetStaticRTTI(), pObject, "ClassPtrArray", 0).Succeeded());
    NS_TEST_BOOL(manager.CanAdd(ExtendedOuterClass::GetStaticRTTI(), pObject, "ClassPtrArray", 0).Succeeded());
    NS_TEST_BOOL(!manager.CanAdd(nsReflectedClass::GetStaticRTTI(), pObject, "ClassPtrArray", 0).Succeeded());

    for (nsInt32 i = 0; i < NS_ARRAY_SIZE(pChildren); i++)
    {
      NS_TEST_BOOL(manager.CanAdd(nsObjectTest::GetStaticRTTI(), pChildObject, szProperty, i).Succeeded());
    ...
    NS_TEST_BOOL_MSG(manager.CanMove(pObject, pChildObject, szProperty, 0).Failed(), "Can't move to own child");
    NS_TEST_BOOL_MSG(manager.CanMove(pChildren[1], pChildObject, szProperty, 1).Failed(), "Can't move before onself");
    NS_TEST_BOOL_MSG(manager.CanMove(pChildren[1], pChildObject, szProperty, 2).Failed(), "Can't move after oneself");
    NS_TEST_BOOL_MSG(manager.CanMove(pChildren[1], pChildren[1], szProperty, 0).Failed(), "Can't move into yourself");
  }
  ...
  NS_TEST_BLOCK(nsTestBlock::Enabled, "DocumentSubElementObject")
  {
    ...
    {
      NS_TEST_BOOL(manager.CanAdd(OuterClass::GetStaticRTTI(), pObject, szProperty, i).Succeeded());
    ...
    NS_TEST_BOOL(manager.CanRemove(pSubElementObject[0]).Succeeded());
    ...
    NS_TEST_BOOL(manager.CanMove(pSubElementObject[1], pObject, szProperty, 2).Succeeded());
    manager.MoveObject(pSubElementObject[1], pObject, szProperty, 2);
    NS_TEST_BOOL(manager.CanMove(pSubElementObject[3], pObject, szProperty, 0).Succeeded());
    ...
    NS_TEST_BOOL(manager.CanRemove(pSubElementObject[3]).Succeeded());
    ...
    NS_TEST_BOOL(manager.CanMove(pSubElementObject[1], pChildObject, szProperty, 0).Succeeded());
    manager.MoveObject(pSubElementObject[1], pChildObject, szProperty, 0);
    NS_TEST_BOOL(manager.CanMove(pSubElementObject[2], pChildObject, szProperty, 0).Succeeded());
