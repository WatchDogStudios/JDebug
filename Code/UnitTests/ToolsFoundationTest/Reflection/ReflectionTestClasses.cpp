...
// clang-format off
NS_BEGIN_STATIC_REFLECTED_TYPE(nsVariantTestStruct, nsNoBase, 1, nsRTTIDefaultAllocator<nsVariantTestStruct>)
{
  NS_BEGIN_PROPERTIES
  {
    NS_MEMBER_PROPERTY("Variant", m_Variant),
    NS_ARRAY_MEMBER_PROPERTY("VariantArray", m_VariantArray),
    NS_MAP_MEMBER_PROPERTY("VariantDictionary", m_VariantDictionary)
  }
  NS_END_PROPERTIES;
}
