...
struct nsVariantTestStruct
{
public:
  nsVariant m_Variant;
  nsVariantArray m_VariantArray;
  nsVariantDictionary m_VariantDictionary;
};
NS_DECLARE_REFLECTABLE_TYPE(NS_NO_LINKAGE, nsVariantTestStruct);
...
public:
  nsPODClass()
  {
    ...
    m_VarianceAngle = nsVarianceTypeAngle(nsAngle::MakeFromDegree(90.0f), 0.1f);
  }
