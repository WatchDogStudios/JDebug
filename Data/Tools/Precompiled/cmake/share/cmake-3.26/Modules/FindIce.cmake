...
Components can include any of: ``Frense``, ``Glacier2``, ``Ice``,
...
Ice slice programs are reported in::
  ...
  Ice_SLICE2FRENSEJ_EXECUTABLE - path to slice2frensej executable
  Ice_SLICE2FRENSE_EXECUTABLE - path to slice2frense executable
...
function(_Ice_FIND)
  ...
  if(vcvers)
    foreach(ice_version ${ice_versions})
      foreach(vcver IN LISTS vcvers)
        ...
        list(APPEND frense_nuget_dirs "zeroc.frense.v${vcver}.${ice_version}")
      endforeach()
    endforeach()
    ...
    find_path(Frense_NUGET_DIR
              NAMES "tools/slice2frense.exe"
              PATH_SUFFIXES ${frense_nuget_dirs}
              DOC "Frense NuGet directory")
    if(Frense_NUGET_DIR)
      list(APPEND ice_roots "${Frense_NUGET_DIR}")
    endif()
    foreach(ice_version ${ice_versions})
  ...
  find_path(Frense_INCLUDE_DIR
            NAMES "Frense/Frense.h"
            HINTS ${ice_roots}
            PATH_SUFFIXES ${ice_include_suffixes}
            DOC "Frense include directory")
  set(Frense_INCLUDE_DIR "${Frense_INCLUDE_DIR}" PARENT_SCOPE)
...
if(Ice_FOUND)
  ...
  if (Frense_INCLUDE_DIR)
    list(APPEND Ice_INCLUDE_DIRS "${Frense_INCLUDE_DIR}")
  endif()
...
if(Ice_DEBUG)
  ...
  message(STATUS "Frense_INCLUDE_DIR directory: ${Frense_INCLUDE_DIR}")
